...
export default function IntegrationsPanel() {
  ...
  return (
    <div className="r-card">
      <p className="r-section-label" style={{ marginBottom: "var(--space-md)" }}>{t("integrations")}</p>

      <div className="r-integration-row">
        <div className={`r-dot ${google.connected ? "connected" : "pending"}`} />
